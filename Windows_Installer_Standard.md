...
AppFleet открывает такой EXE только как ресурсный модуль без выполнения его кода и выбирает встроенный вариант размером до `256×256`. Поэтому отсутствие этих ресурсов или только малые растровые слои приводит к ухудшению иконки в AppFleet и является нарушением стандарта.
